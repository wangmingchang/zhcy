...
public class RedisClientTemplate  {
	...
	public static RedisClientTemplate redisClient= new RedisClientTemplate();
	@SuppressWarnings("resource")
	public static RedisClientTemplate getInstance(){
	...
	public String set(String key,String value){
		...
		ShardedJedis redisClient = redisDataSource.getRedisClient();
		if(redisClient == null) return result;
		boolean broken = false;
		try {
			result = redisClient.set(key, value);
		} catch (Exception e) {
			log.error("redis:set出错", e);
			broken = true;
		}finally{
